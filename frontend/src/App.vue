      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            <li style="margin-left: 50px;"><router-link to="/products" class="nav-link px-2 text-secondary">Products</router-link></li>
            <li><router-link to="/urlist" class="nav-link px-2 text-white">Your Lists</router-link></li>
            <li><router-link to="/add" class="nav-link px-2 text-white">Add Product</router-link></li>
          </ul>

          <div class="text-end">
            <template v-if="isLoggedIn">
              <span class="text-white me-2">{{ userEmail }}</span>
...
export default {
  ...
  data() {
    return {
      isLoggedIn: false, // This should be replaced with actual login status
      userEmail: '' // This will store the user's email
    } 
  },
  methods: {
    logout() {
